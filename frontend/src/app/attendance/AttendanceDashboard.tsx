...
export function AttendanceDashboard() {
  ...
  if (loading && !status) return <div className="text-foreground p-8">Loading...</div>;
  ...
  return (
    <div className="flex-1 overflow-auto bg-background text-foreground p-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Track your hours and manage your timesheets.</p>
      </div>

      <div className="bg-card border border-border p-8 rounded-2xl flex flex-col items-center justify-center space-y-6">
        ...
        {status?.state === "out" && (
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-[#8b5cf6] to-[#ec4899] rounded-xl font-semibold text-foreground shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] transition-all"
          >
            Clock In Now
          </button>
        )}
        ...
        {status?.state === "in" && (
          <button
            ...
            className="px-8 py-3 bg-card/50 border border-white/10 hover:bg-card/10 rounded-xl font-semibold text-foreground transition-all"
          >
            Clock Out
          </button>
        )}
      ...
      <div>
        <h3 className="text-lg font-semibold mb-4 text-foreground">Recent Timesheets</h3>
