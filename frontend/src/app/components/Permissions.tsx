...
export function Permissions({ onViewChange }: { onViewChange: (v: ViewState) => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-card text-foreground p-8 relative overflow-hidden font-sans">
        ...
        <div className="col-span-2 border border-border bg-card text-card-foreground/50 rounded-2xl p-6 flex flex-col overflow-hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search users..." className="bg-input border border-border rounded-xl pl-9 pr-3 py-1.5 text-xs outline-none focus:border-[#8b5cf6]/50 w-64" />
            </div>
          </div>
