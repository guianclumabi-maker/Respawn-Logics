  ...
  },
  {
    ...
    items: [
      ...
      ...(tenantId !== null ? [{ 
        ...
        color: "#00e07a", 
        externalLink: /demo=/.test(window.location.href) ? undefined : "/pages/admin_platform_support.php",
        onClick: /demo=/.test(window.location.href) ? () => { window.dispatchEvent(new CustomEvent('toast', { detail: { type: 'info', message: 'Platform Support is disabled in Live Preview.' } })); } : undefined
      }] : []),
    ]
  },
