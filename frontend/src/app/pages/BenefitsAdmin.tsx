                  ...
                  {isLoading ? (
                    ...
                    plans.map(p => (
                      <tr key={p.id}>
                        ...
                        <td className="p-3 border-b border-border text-white text-sm">{p.provider}</td>
                        <td className="p-3 border-b border-border text-foreground text-sm">
                          <span className="bg-white/10 px-2 py-1 rounded text-xs">{p.type}</span>
                        </td>
                        <td className="p-3 border-b border-border text-white text-sm">${parseFloat(p.company_cost).toLocaleString()}</td>
                        <td className="p-3 border-b border-border text-white text-sm">${parseFloat(p.employee_cost).toLocaleString()}</td>
                  ...
                  {isLoading ? (
                    ...
                    enrollments.map(e => (
                      <tr key={e.id}>
                        ...
                        <td className="p-3 border-b border-border text-white text-sm">{e.plan_name}</td>
                        <td className="p-3 border-b border-border text-white text-sm">{e.type}</td>
                        <td className="p-3 border-b border-border text-white text-sm">{e.dependent_count}</td>
