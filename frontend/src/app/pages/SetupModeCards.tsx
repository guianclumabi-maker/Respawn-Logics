...
export function SetupModeCards() {
  ...
  return (
    <div className="h-screen bg-background bg-[linear-gradient(to_right,rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:40px_40px] font-['Space_Grotesk'] selection:bg-[#00e07a]/30 overflow-y-auto relative text-foreground">
      ...
      {/* HEADER */}
      <nav className="border-b border-white/[0.07] bg-background/90 backdrop-blur-[20px] fixed top-0 left-0 right-0 z-50 h-[62px] flex items-center justify-between px-6 md:px-12">
        <a href="#/" className="flex items-center gap-[10px] no-underline font-['JetBrains_Mono'] text-[0.9375rem] font-bold text-foreground">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 mt-16 pb-24 relative z-10">
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { title: "Co-op Mode", desc: "1-100 employees. Minimal mapping, automatic suggestions.", icon: Users, mode: "Small", color: "text-foreground", bg: "bg-card text-card-foreground", border: "hover:border-[#00e07a]/50" },
              { title: "Multiplayer Guild", desc: "100-500 employees. Department structures and multiple admins.", icon: Shield, mode: "Mid", color: "text-foreground", bg: "bg-card text-card-foreground", border: "hover:border-[#4f8ef7]/50" },
              ...
              <div key={i} onClick={() => handleModeSelect(s.mode as SetupMode)} className={`group bg-card text-card-foreground border border-white/[0.05] ${s.border} rounded-xl p-8 cursor-pointer transition-all hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex flex-col items-center text-center relative overflow-hidden`}>
                <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
                <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
                <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
                <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
          ...
          <div className="max-w-sm mx-auto">
            <div onClick={() => handleModeSelect("Solo")} className={`group bg-card text-card-foreground border border-white/[0.05] hover:border-[#00e07a]/50 rounded-xl p-8 cursor-pointer transition-all hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex flex-col items-center text-center relative overflow-hidden`}>
              <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
              <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
              <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
              <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-border group-hover:border-[#00e07a]/50 transition-colors m-2"></div>
