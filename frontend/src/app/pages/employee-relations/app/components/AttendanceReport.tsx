          ...
          <div className="flex gap-3">
            {hasPermission("attendance.view") && (
              <button 
                ...
                className="px-4 py-2 bg-card border border-border hover:bg-accent rounded-lg font-bold text-sm text-slate-700 dark:text-white transition-all shadow-sm flex items-center gap-2 cursor-pointer"
              >
            ...
            <button 
              onClick={fetchReport}
              disabled={loading}
              className="px-4 py-2 bg-card border border-border hover:bg-accent rounded-lg font-bold text-sm text-slate-700 dark:text-white transition-all shadow-sm flex items-center gap-2 cursor-pointer disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-card/40 border border-border p-4 rounded-xl shadow-sm">
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full h-10 bg-background border border-border rounded-lg px-3 text-sm focus:outline-none focus:border-[#10b981]/50 [color-scheme:dark]"
              />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-10 bg-muted border border-border rounded-lg px-3 text-sm focus:outline-none focus:border-[#10b981]/50"
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full h-10 bg-background border border-border rounded-lg pl-9 pr-3 text-sm focus:outline-none focus:border-[#10b981]/50"
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-6">
        ...
        {error ? (
          <div className="flex flex-col items-center justify-center py-16 px-6 bg-red-500/10 border border-red-500/20 rounded-xl max-w-xl mx-auto text-center space-y-3">
            ...
            <h3 className="text-lg font-bold text-foreground">Report Generation Failed</h3>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm relative">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead className="border-b border-border bg-background text-xs font-bold text-slate-500 uppercase tracking-wider">
                    <tr>
