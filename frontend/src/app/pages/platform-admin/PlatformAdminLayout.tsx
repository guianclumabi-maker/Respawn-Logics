...
export function PlatformAdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      {/* ── Sidebar ── */}
      <aside className="w-64 flex-shrink-0 flex flex-col bg-background border-r border-white/[0.05] h-full">
        {/* Brand */}
        <div className="px-5 py-5 border-b border-white/[0.05] flex items-center gap-3">
          ...
          <div>
            <p className="text-[0.8rem] font-bold text-foreground tracking-wide leading-tight">Command Center</p>
        ...
        <div className="px-3 pb-4 border-t border-border pt-3">
          <div className="flex items-center gap-3 px-3 py-2.5 bg-violet-500/5 border border-violet-500/10 rounded-xl">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-foreground truncate">{user?.name ?? "Platform Admin"}</p>
