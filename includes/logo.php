...
function renderLogo($variant = 'centered') {
    ...
    if ($variant === 'centered') {
        ...
        <div style="display:flex; align-items:center; gap:10px;">
            <div style="width:32px; height:32px; border-radius:7px; background:linear-gradient(135deg, #00e07a, #00b8ff); display:flex; align-items:center; justify-content:center; flex-shrink:0; box-shadow:0 4px 12px rgba(0,224,122,0.2);">
