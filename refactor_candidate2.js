...
// Find the LAST occurrence of endTarget
const lastIndex = code.lastIndexOf(endTarget);
if (lastIndex !== -1) {
  code = code.substring(0, lastIndex) + toastUI + code.substring(lastIndex + endTarget.length);
